...
#include <CubeSat/CubeSatDeployment/Top/CubeSatDeploymentTopology.hpp>
// OSAL initialization
#include <Os/Os.hpp>
...
int main(int argc, char* argv[]) {
    ...
    CubeSat::setupTopology(inputs);
    CubeSat::startRateGroups(Fw::TimeInterval(1,0));  // Program loop cycling rate groups at 1Hz
    CubeSat::teardownTopology(inputs);
